	...
	public static void main(String [] args) {
				...
				numToCheck += increment)
		{
			...
			for(int i = 0; i < trials; i++) {
				...
				BasicDocument bDoc = new BasicDocument(getStringFromFile(textfile, numToCheck));
				bDoc.getFleschScore();
				double interval = (System.nanoTime() - begin) / 1e9;
				total1 += interval;
			}
			avg1 = total1 / trials;
			...
			for(int i = 0; i < trials; i++) {
				...
				EfficientDocument eDoc = new EfficientDocument(getStringFromFile(textfile, numToCheck));
				eDoc.getFleschScore();
				double interval2 = (System.nanoTime() - begin2) / 1e9;
				total2 += interval2;
			}
			avg2 = total2 / trials;
